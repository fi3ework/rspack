...
__export(index_exports, {
  ...
  NormalModule: () => import_binding2.NormalModule,
...
var ChunkGroup = class _ChunkGroup {
  ...
  static __from_binding(binding14) {
    let chunkGroup = CHUNK_GROUP_MAPPINGS.get(binding14);
    if (chunkGroup) {
      return chunkGroup;
    }
    chunkGroup = new _ChunkGroup(binding14);
    CHUNK_GROUP_MAPPINGS.set(binding14, chunkGroup);
    return chunkGroup;
  }
  constructor(inner) {
    this.#inner = inner;
      ...
      chunks: {
        ...
        get: () => {
          return this.#inner.chunks.map(
            (binding14) => Chunk.__from_binding(binding14)
          );
        }
      },
      index: {
  ...
  getParents() {
    return this.#inner.getParents().map((binding14) => _ChunkGroup.__from_binding(binding14));
  }
  isInitial() {
    return this.#inner.isInitial();
  }
  getModulePreOrderIndex(module2) {
    return this.#inner.getModulePreOrderIndex(module2);
  }
  getModulePostOrderIndex(module2) {
    return this.#inner.getModulePostOrderIndex(module2);
  }
};
...
var Chunk = class _Chunk {
  #inner;
  static __from_binding(binding14) {
    let chunk = CHUNK_MAPPINGS.get(binding14);
    if (chunk) {
      return chunk;
    }
    chunk = new _Chunk(binding14);
    CHUNK_MAPPINGS.set(binding14, chunk);
    return chunk;
  }
  ...
  constructor(binding14) {
    ...
    Object.defineProperties(this, {
      ...
      ids: {
        enumerable: true,
        get: () => {
          return binding14.ids;
        }
      },
      idNameHints: {
        enumerable: true,
        get: () => {
          return binding14.idNameHints;
        }
      },
      filenameTemplate: {
        enumerable: true,
        get: () => {
          return binding14.filenameTemplate;
        }
      },
      cssFilenameTemplate: {
        enumerable: true,
        get: () => {
          return binding14.cssFilenameTemplate;
        }
      },
      files: {
        enumerable: true,
        get: () => {
          return new Set(binding14.files);
        }
      },
      runtime: {
        enumerable: true,
        get: () => {
          return new Set(binding14.runtime);
        }
      },
      hash: {
        enumerable: true,
        get: () => {
          return binding14.hash;
        }
      },
      contentHash: {
        enumerable: true,
        get: () => {
          return binding14.contentHash;
        }
      },
      renderedHash: {
        enumerable: true,
        get: () => {
          return binding14.renderedHash;
        }
      },
      chunkReason: {
        enumerable: true,
        get: () => {
          return binding14.chunkReason;
        }
      },
      auxiliaryFiles: {
        enumerable: true,
        get: () => {
          return new Set(binding14.auxiliaryFiles);
        }
      }
    });
  }
  ...
  get groupsIterable() {
    return new Set(
      this.#inner.groups().map((binding14) => ChunkGroup.__from_binding(binding14))
    );
  }
  ...
  getAllAsyncChunks() {
    return new Set(
      this.#inner.getAllAsyncChunks().map((binding14) => _Chunk.__from_binding(binding14))
    );
  }
  getAllInitialChunks() {
    return new Set(
      this.#inner.getAllInitialChunks().map((binding14) => _Chunk.__from_binding(binding14))
    );
  }
  getAllReferencedChunks() {
    return new Set(
      this.#inner.getAllReferencedChunks().map((binding14) => _Chunk.__from_binding(binding14))
    );
  }
  getEntryOptions() {
...
var ChunkGraph = class _ChunkGraph {
  #inner;
  static __from_binding(binding14) {
    return new _ChunkGraph(binding14);
  }
  constructor(binding14) {
    this.#inner = binding14;
  }
  ...
  getChunkEntryDependentChunksIterable(chunk) {
    return this.#inner.getChunkEntryDependentChunksIterable(Chunk.__to_binding(chunk)).map((binding14) => Chunk.__from_binding(binding14));
  }
  ...
  getModuleChunks(module2) {
    return this.#inner.getModuleChunks(module2).map((binding14) => Chunk.__from_binding(binding14));
  }
  ...
  getBlockChunkGroup(depBlock) {
    const binding14 = this.#inner.getBlockChunkGroup(depBlock);
    return binding14 ? ChunkGroup.__from_binding(binding14) : null;
  }
};
...
var Entrypoint = class _Entrypoint extends ChunkGroup {
  #inner;
  static __from_binding(binding14) {
    let entrypoint = ENTRYPOINT_MAPPINGS.get(binding14);
    if (entrypoint) {
      return entrypoint;
    }
    entrypoint = new _Entrypoint(binding14);
    ENTRYPOINT_MAPPINGS.set(binding14, entrypoint);
    return entrypoint;
  }
  constructor(binding14) {
    super(binding14);
...
var ExportsInfo = class _ExportsInfo {
  #inner;
  static __from_binding(binding14) {
    return new _ExportsInfo(binding14);
  }
  constructor(binding14) {
    this.#inner = binding14;
  }
...
var ModuleGraph = class _ModuleGraph {
  static __from_binding(binding14) {
    return new _ModuleGraph(binding14);
  }
  #inner;
  constructor(binding14) {
    this.#inner = binding14;
  ...
  getIssuer(module2) {
    return this.#inner.getIssuer(module2);
  }
...
var Stats = class {
  ...
  toJson(opts, forToString) {
    ...
    try {
      ...
      console.warn(
        `Failed to get stats due to error: ${e == null ? void 0 : e.message}, are you trying to access the stats from the previous compilation?`
      );
    }
    return stats;
  }
        ...
        __privateGet(this, _inner).rebuildModule(
          ...
          (err, modules) => {
            if (err) {
              ...
              doneWork(modules.map((module2) => [null, module2]));
            }
          }
        );
      }
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
   ...
   */
  get assets() {
    return __privateMethod(this, _Compilation_instances, createCachedAssets_fn).call(this);
  }
  /**
  ...
  get entrypoints() {
    return new Map(
      __privateGet(this, _inner).entrypoints.map((binding14) => {
        const entrypoint = Entrypoint.__from_binding(binding14);
  ...
  get chunkGroups() {
    return __privateGet(this, _inner).chunkGroups.map(
      (binding14) => ChunkGroup.__from_binding(binding14)
    );
  }
  /**
    ...
    return createReadonlyMap({
      ...
      get: (property) => {
        if (typeof property === "string") {
          const binding14 = __privateGet(this, _inner).getNamedChunkGroup(property);
          return ChunkGroup.__from_binding(binding14);
        }
      }
    });
  }
  get modules() {
    return new Set(__privateGet(this, _inner).modules);
  }
  get builtModules() {
    return new Set(__privateGet(this, _inner).builtModules);
  }
  get chunks() {
  ...
  get namedChunks() {
    return createReadonlyMap({
      ...
      get: (property) => {
        if (typeof property === "string") {
          const binding14 = __privateGet(this, _inner).getNamedChunk(property);
          return binding14 ? Chunk.__from_binding(binding14) : void 0;
        }
      }
    });
  }
  ...
  rebuildModule(module2, f) {
    __privateGet(this, _rebuildModuleTask).exec(module2.identifier(), f);
  }
  ...
  __internal__getChunks() {
    return __privateGet(this, _inner).getChunks().map((binding14) => Chunk.__from_binding(binding14));
  }
  /**
   * Note: This is not a webpack public API, maybe removed in future.
   *
...
var AddIncludeDispatcher = class {
  ...
  #execute = () => {
    ...
    this.#inner(args, (wholeErr, results) => {
      ...
      for (let i = 0; i < results.length; i++) {
        const [errMsg, module2] = results[i];
        const cb = cbs[i];
        cb(errMsg ? new WebpackError_default(errMsg) : null, module2);
      }
    });
  };
  constructor(binding14) {
...
var EntryData = class _EntryData {
  static __from_binding(binding14) {
    return new _EntryData(binding14);
  }
  constructor(binding14) {
    this.dependencies = binding14.dependencies;
    this.includeDependencies = binding14.includeDependencies;
    this.options = binding14.options;
  }
};
var Entries = class {
  #data;
  ...
  forEach(callback, thisArg) {
    for (const [key, binding14] of this) {
      const value = EntryData.__from_binding(binding14);
      callback.call(thisArg, value, key, this);
    }
  }
  get size() {
  ...
  *entries() {
  ...
  get(key) {
    const binding14 = this.#data.get(key);
    return binding14 ? EntryData.__from_binding(binding14) : void 0;
  }
  keys() {
...
function each(collection, iterator, originalCallback) {
...
var LazyHashedEtag = class {
   ...
   */
  constructor(obj, hashFunction2 = "xxhash64") {
    this._obj = obj;
    this._hash = void 0;
...
var getter = (obj, hashFunction2 = "xxhash64") => {
  let innerMap;
...
var ContextModuleFactory = class {
  constructor() {
    this.hooks = {
      beforeResolve: new liteTapable2.AsyncSeriesWaterfallHook(["resolveData"]),
      afterResolve: new liteTapable2.AsyncSeriesWaterfallHook(["resolveData"])
    };
  }
};
      ...
      fs5.readdir(p, (err2, files) => {
        ...
        if (count === 0) {
          ...
          for (const file of files) {
            (0, import_node_assert.default)(typeof file === "string");
            const fullPath = join(fs5, p, file);
...
var join = (fs5, rootPath, filename2) => {
  if (fs5 == null ? void 0 : fs5.join) {
    return fs5.join(rootPath, filename2);
  }
  if (import_node_path.default.posix.isAbsolute(rootPath)) {
    return import_node_path.default.posix.join(rootPath, filename2);
  }
  if (import_node_path.default.win32.isAbsolute(rootPath)) {
    return import_node_path.default.win32.join(rootPath, filename2);
  }
  throw new Error(
    `${rootPath} is neither a posix nor a windows path, and there is no 'join' method defined in the file system`
  );
};
var dirname = (fs5, absPath) => {
  if (fs5 == null ? void 0 : fs5.dirname) {
    return fs5.dirname(absPath);
  }
  if (import_node_path.default.posix.isAbsolute(absPath)) {
    return import_node_path.default.posix.dirname(absPath);
  }
  if (import_node_path.default.win32.isAbsolute(absPath)) {
    return import_node_path.default.win32.dirname(absPath);
  }
  throw new Error(
...
var ThreadsafeOutputNodeFS = class _ThreadsafeOutputNodeFS {
  constructor(fs5) {
    ...
    this.writeFile = memoizeFn(() => import_node_util2.default.promisify(fs5.writeFile.bind(fs5)));
    this.removeFile = memoizeFn(() => import_node_util2.default.promisify(fs5.unlink.bind(fs5)));
    this.mkdir = memoizeFn(() => import_node_util2.default.promisify(fs5.mkdir.bind(fs5)));
    this.mkdirp = memoizeFn(() => import_node_util2.default.promisify(mkdirp.bind(null, fs5)));
    this.removeDirAll = memoizeFn(() => import_node_util2.default.promisify(rmrf.bind(null, fs5)));
    this.readDir = memoizeFn(() => {
      const readDirFn = import_node_util2.default.promisify(fs5.readdir.bind(fs5));
      return async (filePath) => {
        const res = await readDirFn(filePath);
        return res;
      };
    });
    this.readFile = memoizeFn(() => import_node_util2.default.promisify(fs5.readFile.bind(fs5)));
    this.stat = memoizeFn(() => {
      const statFn = import_node_util2.default.promisify(fs5.stat.bind(fs5));
      return async (filePath) => {
    ...
    this.lstat = memoizeFn(() => {
      const statFn = import_node_util2.default.promisify((fs5.lstat || fs5.stat).bind(fs5));
      return async (filePath) => {
        const res = await statFn(filePath);
        return res && _ThreadsafeOutputNodeFS.__to_binding_stat(res);
      };
...
var ThreadsafeIntermediateNodeFS = class extends ThreadsafeOutputNodeFS {
  constructor(fs5) {
    ...
    this.open = memoizeFn(() => import_node_util2.default.promisify(fs5.open.bind(fs5)));
    this.rename = memoizeFn(() => import_node_util2.default.promisify(fs5.rename.bind(fs5)));
    this.close = memoizeFn(() => import_node_util2.default.promisify(fs5.close.bind(fs5)));
    this.write = memoizeFn(() => {
      const writeFn = import_node_util2.default.promisify(fs5.write.bind(fs5));
    ...
    this.writeAll = memoizeFn(() => {
      const writeFn = import_node_util2.default.promisify(fs5.writeFile.bind(fs5));
...
var NormalModuleFactory = class {
  constructor(resolverFactory) {
    this.hooks = {
      resolveForScheme: new liteTapable3.HookMap(
        () => new liteTapable3.AsyncSeriesBailHook(["resourceData"])
      ),
      beforeResolve: new liteTapable3.AsyncSeriesBailHook(["resolveData"]),
      factorize: new liteTapable3.AsyncSeriesBailHook(["resolveData"]),
      resolve: new liteTapable3.AsyncSeriesBailHook(["resolveData"]),
      afterResolve: new liteTapable3.AsyncSeriesBailHook(["resolveData"]),
      createModule: new liteTapable3.AsyncSeriesBailHook([
        "createData",
        "resolveData"
      ])
    };
  ...
  getResolver(type, resolveOptions2) {
    return this.resolverFactory.get(type, resolveOptions2);
  }
};
...
var absoluteToRequest = (context2, maybeAbsolutePath) => {
  if (maybeAbsolutePath[0] === "/") {
    ...
    resource = relativePathToRequest(import_node_path2.default.posix.relative(context2, resource));
    return querySplitPos === -1 ? resource : resource + maybeAbsolutePath.slice(querySplitPos);
  }
  if (WINDOWS_ABS_PATH_REGEXP.test(maybeAbsolutePath)) {
    const querySplitPos = maybeAbsolutePath.indexOf("?");
    let resource = querySplitPos === -1 ? maybeAbsolutePath : maybeAbsolutePath.slice(0, querySplitPos);
    resource = import_node_path2.default.win32.relative(context2, resource);
...
var requestToAbsolute = (context2, relativePath) => {
  if (relativePath.startsWith("./") || relativePath.startsWith("../"))
    return import_node_path2.default.join(context2, relativePath);
  return relativePath;
};
  ...
  for (const name2 of Object.keys(descriptors)) {
    ...
    if (typeof descriptor.value === "function") {
      Object.defineProperty(newObj, name2, {
        ...descriptor,
        value: import_node_util3.default.deprecate(descriptor.value, message, code)
      });
    } else if (descriptor.get || descriptor.set) {
      Object.defineProperty(newObj, name2, {
        ...descriptor,
        get: descriptor.get && import_node_util3.default.deprecate(descriptor.get, message, code),
        set: descriptor.set && import_node_util3.default.deprecate(descriptor.set, message, code)
      });
    } else {
      ...
      Object.defineProperty(newObj, name2, {
        ...
        get: import_node_util3.default.deprecate(() => value, message, code),
        set: descriptor.writable ? import_node_util3.default.deprecate((v) => value = v, message, code) : void 0
      });
    }
  }
  return newObj;
  ...
  value(compilation) {
    ...
    if (hooks === void 0) {
      hooks = {
        ...
        readResourceForScheme: new liteTapable4.HookMap((scheme) => {
        ...
        readResource: new liteTapable4.HookMap(
...
async function runLoaders(compiler, context2) {
  ...
  const contextDirectory = resourcePath ? dirname2(resourcePath) : null;
  ...
  loaderContext.emitError = function emitError(err) {
    ...
    compiler._lastCompilation.__internal__pushRspackDiagnostic({
      error,
      severity: import_binding3.JsRspackSeverity.Error
    });
  };
  loaderContext.emitWarning = function emitWarning(warn) {
    ...
    compiler._lastCompilation.__internal__pushRspackDiagnostic({
      error: warning,
      severity: import_binding3.JsRspackSeverity.Warn
    });
  };
  loaderContext.emitFile = function emitFile(name2, content, sourceMap, assetInfo) {
    ...
    loaderContext._module.emitFile(name2, source, assetInfo);
  };
  ...
  loaderContext.experiments = {
    emitDiagnostic: (diagnostic) => {
      const d = Object.assign({}, diagnostic, {
        ...
        moduleIdentifier: context2._module.identifier()
      });
      compiler._lastCompilation.__internal__pushDiagnostic(
        (0, import_binding3.formatDiagnostic)(d)
      );
    }
  };
  ...
  loaderContext._module = context2._module;
  ...
  let step = 0;
  while (compilation) {
    import_binding2.NormalModule.getCompilationHooks(compilation).loader.call(
      loaderContext,
  ...
  try {
    switch (loaderState) {
      ...
      case import_binding3.JsLoaderState.Normal: {
...
function getRawRuleSetCondition(condition) {
  if (typeof condition === "string") {
    return {
      type: import_binding4.RawRuleSetConditionType.string,
      string: condition
    };
  }
  if (condition instanceof RegExp) {
    return {
      type: import_binding4.RawRuleSetConditionType.regexp,
      regexp: condition
    };
  }
  if (typeof condition === "function") {
    return {
      type: import_binding4.RawRuleSetConditionType.func,
      func: condition
    };
  }
  if (Array.isArray(condition)) {
    return {
      type: import_binding4.RawRuleSetConditionType.array,
      array: condition.map((i) => getRawRuleSetCondition(i))
    };
  }
  if (typeof condition === "object" && condition !== null) {
    return {
      type: import_binding4.RawRuleSetConditionType.logical,
...
function getRawAssetGeneratorDataUrl(dataUrl) {
  ...
  if (typeof dataUrl === "function" && dataUrl !== null) {
    return (source, context2) => {
      return dataUrl(source, context2);
    };
  }
  throw new Error(
...
function getRawJsonGeneratorOptions(options) {
  return {
...
var APIPlugin = create2(import_binding5.BuiltinPluginName.APIPlugin, () => {
});
...
var ArrayPushCallbackChunkFormatPlugin = create2(
  import_binding6.BuiltinPluginName.ArrayPushCallbackChunkFormatPlugin,
  () => {
  }
);
...
var AssetModulesPlugin = create2(
  import_binding7.BuiltinPluginName.AssetModulesPlugin,
  () => {
  },
  "compilation"
);
...
var AsyncWebAssemblyModulesPlugin = create2(
  import_binding8.BuiltinPluginName.AsyncWebAssemblyModulesPlugin,
  () => {
  },
  "compilation"
);
...
var BannerPlugin = create2(
  import_binding9.BuiltinPluginName.BannerPlugin,
  (args) => {
...
var BundlerInfoRspackPlugin = create2(
  import_binding10.BuiltinPluginName.BundlerInfoRspackPlugin,
  (options) => {
    return {
...
var normalizeValue = (define, supportsBigIntLiteral) => {
  ...
  const normalizeObject = (define2) => {
    if (Array.isArray(define2)) {
      return define2.map(normalizeObject);
    }
    if (define2 instanceof RegExp) {
      return normalizePrimitive(define2);
    }
    if (define2 && typeof define2 === "object") {
...
var EnableChunkLoadingPlugin = class extends EnableChunkLoadingPluginInner {
...
var getEnabledTypes2 = (compiler) => {
  ...
  if (set === void 0) {
    set = /* @__PURE__ */ new Set();
    enabledTypes2.set(compiler, set);
  }
  return set;
};
...
var getPluginHooks = (compilation) => {
  ...
  if (hooks === void 0) {
    hooks = {
      ...
      alterAssetTags: new liteTapable5.AsyncSeriesWaterfallHook(["data"]),
      alterAssetTagGroups: new liteTapable5.AsyncSeriesWaterfallHook(["data"]),
      afterTemplateExecution: new liteTapable5.AsyncSeriesWaterfallHook([
        "data"
      ]),
...
var templateRenderFunction = import_zod.z.function().args(import_zod.z.record(import_zod.z.string(), import_zod.z.any())).returns(
  import_zod.z.string().or(import_zod.z.promise(import_zod.z.string()))
);
var templateParamFunction = import_zod.z.function().args(import_zod.z.record(import_zod.z.string(), import_zod.z.any())).returns(
  import_zod.z.record(import_zod.z.string(), import_zod.z.any()).or(import_zod.z.promise(import_zod.z.record(import_zod.z.string(), import_zod.z.any())))
);
var templateFilenameFunction = import_zod.z.function().args(import_zod.z.string()).returns(import_zod.z.string());
var pluginOptionsSchema = import_zod.z.strictObject({
  filename: import_zod.z.string().or(templateFilenameFunction).optional(),
  template: import_zod.z.string().refine(
    (val) => !val.includes("!"),
    () => ({
      message: "HtmlRspackPlugin does not support template path with loader yet"
    })
  ).optional(),
  templateContent: import_zod.z.string().or(templateRenderFunction).optional(),
  templateParameters: import_zod.z.record(import_zod.z.string()).or(import_zod.z.boolean()).or(templateParamFunction).optional(),
  inject: import_zod.z.enum(["head", "body"]).or(import_zod.z.boolean()).optional(),
  publicPath: import_zod.z.string().optional(),
  base: import_zod.z.string().or(
    import_zod.z.strictObject({
      href: import_zod.z.string().optional(),
      target: import_zod.z.enum(["_self", "_blank", "_parent", "_top"]).optional()
    })
  ).optional(),
  scriptLoading: import_zod.z.enum(["blocking", "defer", "module", "systemjs-module"]).optional(),
  chunks: import_zod.z.string().array().optional(),
  excludeChunks: import_zod.z.string().array().optional(),
  chunksSortMode: import_zod.z.enum(["auto", "manual"]).optional(),
  sri: import_zod.z.enum(["sha256", "sha384", "sha512"]).optional(),
  minify: import_zod.z.boolean().optional(),
  title: import_zod.z.string().optional(),
  favicon: import_zod.z.string().optional(),
  meta: import_zod.z.record(import_zod.z.string().or(import_zod.z.record(import_zod.z.string()))).optional(),
...
var IgnorePluginOptions = import_zod2.z.union([
  import_zod2.z.object({
    contextRegExp: import_zod2.z.instanceof(RegExp).optional(),
    resourceRegExp: import_zod2.z.instanceof(RegExp)
  }),
  import_zod2.z.object({
    checkResource: import_zod2.z.function(import_zod2.z.tuple([import_zod2.z.string(), import_zod2.z.string()]), import_zod2.z.boolean())
  })
]);
...
var RuntimePluginImpl = create2(
  binding2.BuiltinPluginName.RuntimePlugin,
  () => {
  },
  "compilation"
);
...
var createRuntimePluginHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerRuntimePluginCreateScriptTaps: createTap(
      binding2.RegisterJsTapKind.RuntimePluginCreateScript,
      function() {
    ...
    registerRuntimePluginLinkPreloadTaps: createTap(
      binding2.RegisterJsTapKind.RuntimePluginLinkPreload,
      function() {
        return RuntimePlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).linkPreload;
    ...
    registerRuntimePluginLinkPrefetchTaps: createTap(
      binding2.RegisterJsTapKind.RuntimePluginLinkPrefetch,
      function() {
        return RuntimePlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).linkPrefetch;
  ...
  function getName(name3) {
    if (typeof name3 === "function") {
      return (ctx) => {
        ...
        return name3(ctx.module, getChunks(ctx.chunks), ctx.cacheGroupKey);
      };
    }
    return name3;
  }
...
var rsdoctorPluginSchema = import_zod3.z.strictObject({
  moduleGraphFeatures: import_zod3.z.union([import_zod3.z.boolean(), import_zod3.z.array(import_zod3.z.enum(["graph", "ids", "sources"]))]).optional(),
...
RsdoctorPlugin.getHooks = RsdoctorPlugin.getCompilationHooks = (compilation) => {
  ...
  if (hooks === void 0) {
    hooks = {
      ...
      chunkGraph: new liteTapable8.AsyncSeriesBailHook(["chunkGraph"]),
      moduleIds: new liteTapable8.AsyncSeriesBailHook(["moduleIdsPatch"]),
...
var applyRspackOptionsDefaults = (options) => {
  ...
  (0, import_node_assert6.default)(!isNil(target2));
...
var applyJsonGeneratorOptionsDefaults = (generatorOptions) => {
...
var applyModuleDefaults = (module2, {
  ...
  F(module2.generator, "json", () => ({}));
  assertNotNill(module2.generator.json);
  applyJsonGeneratorOptionsDefaults(module2.generator.json);
  if (css) {
...
while determining default 'output.uniqueName' from 'name' in ${pkgPath}`;
  ...
  D(output2, "hashFunction", "xxhash64");
  D(output2, "hashDigest", "hex");
  D(output2, "hashDigestLength", 16);
  ...
  return {
    ...
    output: nestedConfig(config2.output, (output2) => {
      if ("cssHeadDataCompression" in output2) {
        import_node_util5.default.deprecate(
          () => {
          },
...
var Resolver = class _Resolver {
  ...
  withOptions({
    ...
    return new _Resolver(binding14);
  }
};
...
var ResolverFactory = class {
  ...
  constructor(pnp) {
    this.#binding = new binding3.JsResolverFactory(pnp);
  }
  get(type, resolveOptions2) {
    const { dependencyCategory, resolveToContext, ...resolve2 } = resolveOptions2 || {};
    const binding14 = this.#binding.get(type, {
      ...getRawResolve(resolve2),
      dependencyCategory,
      resolveToContext
    });
    return new Resolver(binding14);
  }
};
...
var getAddonPlatformArchAbi = () => {
  ...
  if (typeof abi === "string") {
    binding14 += abi.length ? `-${abi}` : "";
  } else if (typeof abi === "object") {
    binding14 += `-${abi[isMusl() ? "musl" : "gnu"]}`;
  } else {
...
var createHtmlPluginHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerHtmlPluginBeforeAssetTagGenerationTaps: createTap(
      binding4.RegisterJsTapKind.HtmlPluginBeforeAssetTagGeneration,
      function() {
    ...
    registerHtmlPluginAlterAssetTagsTaps: createTap(
      binding4.RegisterJsTapKind.HtmlPluginAlterAssetTags,
      function() {
        return HtmlRspackPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).alterAssetTags;
    ...
    registerHtmlPluginAlterAssetTagGroupsTaps: createTap(
      binding4.RegisterJsTapKind.HtmlPluginAlterAssetTagGroups,
      function() {
        return HtmlRspackPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).alterAssetTagGroups;
    ...
    registerHtmlPluginAfterTemplateExecutionTaps: createTap(
      binding4.RegisterJsTapKind.HtmlPluginAfterTemplateExecution,
      function() {
        return HtmlRspackPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
    ...
    registerHtmlPluginBeforeEmitTaps: createTap(
      binding4.RegisterJsTapKind.HtmlPluginBeforeEmit,
      function() {
        return HtmlRspackPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).beforeEmit;
    ...
    registerHtmlPluginAfterEmitTaps: createTap(
      binding4.RegisterJsTapKind.HtmlPluginAfterEmit,
      function() {
        return HtmlRspackPlugin.getCompilationHooks(
          getCompiler().__internal__get_compilation()
        ).afterEmit;
...
var ContextModuleFactoryBeforeResolveData = class _ContextModuleFactoryBeforeResolveData {
  #inner;
  static __from_binding(binding14) {
    return new _ContextModuleFactoryBeforeResolveData(binding14);
  }
  static __to_binding(data) {
    return data.#inner;
  }
  constructor(binding14) {
    ...
    Object.defineProperties(this, {
      context: {
        enumerable: true,
        get() {
          return binding14.context;
        },
        set(val) {
          binding14.context = val;
        }
      },
      request: {
        enumerable: true,
        get() {
          return binding14.request;
        },
        set(val) {
          binding14.request = val;
        }
      },
      regExp: {
        enumerable: true,
        get() {
          return binding14.regExp;
        },
        set(val) {
          binding14.regExp = val;
        }
      },
      recursive: {
        enumerable: true,
        get() {
          return binding14.recursive;
        },
        set(val) {
          binding14.recursive = val;
        }
      }
    });
  }
...
var ContextModuleFactoryAfterResolveData = class _ContextModuleFactoryAfterResolveData {
  #inner;
  static __from_binding(binding14) {
    return new _ContextModuleFactoryAfterResolveData(binding14);
  }
  static __to_binding(data) {
    return data.#inner;
  }
  constructor(binding14) {
    ...
    Object.defineProperties(this, {
      resource: {
        enumerable: true,
        get() {
          return binding14.resource;
        },
        set(val) {
          binding14.resource = val;
        }
      },
      context: {
        enumerable: true,
...
Object.defineProperty(binding5.Module.prototype, "emitFile", {
  enumerable: true,
  configurable: true,
  value(filename2, source, assetInfo) {
    return this._emitFile(filename2, JsSource.__to_binding(source), assetInfo);
...
var createCompilationHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerCompilationAdditionalTreeRuntimeRequirementsTaps: createTap(
      binding6.RegisterJsTapKind.CompilationAdditionalTreeRuntimeRequirements,
      function() {
    ...
    registerCompilationRuntimeRequirementInTreeTaps: createMapTap(
      binding6.RegisterJsTapKind.CompilationRuntimeRequirementInTree,
      function() {
    ...
    registerCompilationRuntimeModuleTaps: createTap(
      binding6.RegisterJsTapKind.CompilationRuntimeModule,
      function() {
    ...
    registerCompilationBuildModuleTaps: createTap(
      binding6.RegisterJsTapKind.CompilationBuildModule,
      function() {
        return getCompiler().__internal__get_compilation().hooks.buildModule;
      },
      function(queried) {
        return function(module2) {
          return queried.call(module2);
        };
      }
    ),
    registerCompilationStillValidModuleTaps: createTap(
      binding6.RegisterJsTapKind.CompilationStillValidModule,
      function() {
    ...
    registerCompilationSucceedModuleTaps: createTap(
      binding6.RegisterJsTapKind.CompilationSucceedModule,
      function() {
    ...
    registerCompilationExecuteModuleTaps: createTap(
      binding6.RegisterJsTapKind.CompilationExecuteModule,
      function() {
    ...
    registerCompilationFinishModulesTaps: createTap(
      binding6.RegisterJsTapKind.CompilationFinishModules,
      function() {
    ...
    registerCompilationOptimizeModulesTaps: createTap(
      binding6.RegisterJsTapKind.CompilationOptimizeModules,
      function() {
    ...
    registerCompilationAfterOptimizeModulesTaps: createTap(
      binding6.RegisterJsTapKind.CompilationAfterOptimizeModules,
      function() {
    ...
    registerCompilationOptimizeTreeTaps: createTap(
      binding6.RegisterJsTapKind.CompilationOptimizeTree,
      function() {
    ...
    registerCompilationOptimizeChunkModulesTaps: createTap(
      binding6.RegisterJsTapKind.CompilationOptimizeChunkModules,
      function() {
    ...
    registerCompilationChunkHashTaps: createTap(
      binding6.RegisterJsTapKind.CompilationChunkHash,
      function() {
    ...
    registerCompilationChunkAssetTaps: createTap(
      binding6.RegisterJsTapKind.CompilationChunkAsset,
      function() {
    ...
    registerCompilationProcessAssetsTaps: createTap(
      binding6.RegisterJsTapKind.CompilationProcessAssets,
      function() {
    ...
    registerCompilationAfterProcessAssetsTaps: createTap(
      binding6.RegisterJsTapKind.CompilationAfterProcessAssets,
      function() {
    ...
    registerCompilationSealTaps: createTap(
      binding6.RegisterJsTapKind.CompilationSeal,
      function() {
    ...
    registerCompilationAfterSealTaps: createTap(
      binding6.RegisterJsTapKind.CompilationAfterSeal,
      function() {
...
var createCompilerHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerCompilerThisCompilationTaps: createTap(
      binding7.RegisterJsTapKind.CompilerThisCompilation,
      function() {
    ...
    registerCompilerCompilationTaps: createTap(
      binding7.RegisterJsTapKind.CompilerCompilation,
      function() {
    ...
    registerCompilerMakeTaps: createTap(
      binding7.RegisterJsTapKind.CompilerMake,
      function() {
    ...
    registerCompilerFinishMakeTaps: createTap(
      binding7.RegisterJsTapKind.CompilerFinishMake,
      function() {
    ...
    registerCompilerShouldEmitTaps: createTap(
      binding7.RegisterJsTapKind.CompilerShouldEmit,
      function() {
    ...
    registerCompilerEmitTaps: createTap(
      binding7.RegisterJsTapKind.CompilerEmit,
      function() {
    ...
    registerCompilerAfterEmitTaps: createTap(
      binding7.RegisterJsTapKind.CompilerAfterEmit,
      function() {
    ...
    registerCompilerAssetEmittedTaps: createTap(
      binding7.RegisterJsTapKind.CompilerAssetEmitted,
      function() {
...
var createContextModuleFactoryHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerContextModuleFactoryBeforeResolveTaps: createTap(
      binding8.RegisterJsTapKind.ContextModuleFactoryBeforeResolve,
      function() {
    ...
    registerContextModuleFactoryAfterResolveTaps: createTap(
      binding8.RegisterJsTapKind.ContextModuleFactoryAfterResolve,
      function() {
...
var createJavaScriptModulesHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerJavascriptModulesChunkHashTaps: createTap(
      binding9.RegisterJsTapKind.JavascriptModulesChunkHash,
      function() {
...
var createNormalModuleFactoryHooksRegisters = (getCompiler, createTap, createMapTap) => {
  return {
    registerNormalModuleFactoryBeforeResolveTaps: createTap(
      binding10.RegisterJsTapKind.NormalModuleFactoryBeforeResolve,
      function() {
    ...
    registerNormalModuleFactoryFactorizeTaps: createTap(
      binding10.RegisterJsTapKind.NormalModuleFactoryFactorize,
      function() {
    ...
    registerNormalModuleFactoryResolveTaps: createTap(
      binding10.RegisterJsTapKind.NormalModuleFactoryResolve,
      function() {
    ...
    registerNormalModuleFactoryResolveForSchemeTaps: createMapTap(
      binding10.RegisterJsTapKind.NormalModuleFactoryResolveForScheme,
      function() {
    ...
    registerNormalModuleFactoryAfterResolveTaps: createTap(
      binding10.RegisterJsTapKind.NormalModuleFactoryAfterResolve,
      function() {
    ...
    registerNormalModuleFactoryCreateModuleTaps: createTap(
      binding10.RegisterJsTapKind.NormalModuleFactoryCreateModule,
      function() {
...
var Compiler = class _Compiler {
  ...
  constructor(context2, options) {
    ...
    this.hooks = {
      initialize: new liteTapable9.SyncHook([]),
      shouldEmit: new liteTapable9.SyncBailHook(["compilation"]),
      done: new liteTapable9.AsyncSeriesHook(["stats"]),
      afterDone: new liteTapable9.SyncHook(["stats"]),
      beforeRun: new liteTapable9.AsyncSeriesHook(["compiler"]),
      run: new liteTapable9.AsyncSeriesHook(["compiler"]),
      emit: new liteTapable9.AsyncSeriesHook(["compilation"]),
      assetEmitted: new liteTapable9.AsyncSeriesHook(["file", "info"]),
      afterEmit: new liteTapable9.AsyncSeriesHook(["compilation"]),
      thisCompilation: new liteTapable9.SyncHook(["compilation", "params"]),
      compilation: new liteTapable9.SyncHook([
        "compilation",
        "params"
      ]),
      invalid: new liteTapable9.SyncHook(["filename", "changeTime"]),
      compile: new liteTapable9.SyncHook(["params"]),
      infrastructureLog: new liteTapable9.SyncBailHook([
        "origin",
        "type",
        "args"
      ]),
      failed: new liteTapable9.SyncHook(["error"]),
      shutdown: new liteTapable9.AsyncSeriesHook([]),
      normalModuleFactory: new liteTapable9.SyncHook([
        "normalModuleFactory"
      ]),
      contextModuleFactory: new liteTapable9.SyncHook([
        "contextModuleFactory"
      ]),
      watchRun: new liteTapable9.AsyncSeriesHook(["compiler"]),
      watchClose: new liteTapable9.SyncHook([]),
      environment: new liteTapable9.SyncHook([]),
      afterEnvironment: new liteTapable9.SyncHook([]),
      afterPlugins: new liteTapable9.SyncHook(["compiler"]),
      afterResolvers: new liteTapable9.SyncHook(["compiler"]),
      make: new liteTapable9.AsyncParallelHook(["compilation"]),
      beforeCompile: new liteTapable9.AsyncSeriesHook(["params"]),
      afterCompile: new liteTapable9.AsyncSeriesHook(["compilation"]),
      finishMake: new liteTapable9.AsyncSeriesHook(["compilation"]),
      entryOption: new liteTapable9.SyncBailHook(["context", "entry"]),
      additionalPass: new liteTapable9.AsyncSeriesHook([])
    };
    this.webpack = rspack;
    this.rspack = rspack;
    this.root = this;
  ...
  #createHookRegisterTaps(registerKind, getHook, createTap) {
    ...
    const getTaps = (stages) => {
      ...
      const breakpoints = [
        liteTapable9.minStage,
        ...stages,
        liteTapable9.maxStage
      ];
      const jsTaps = [];
      for (let i = 0; i < breakpoints.length - 1; i++) {
        ...
        jsTaps.push({
          ...
          stage: liteTapable9.safeStage(from + 1)
        });
      }
...
var liteTapable10 = __toESM(require("@rspack/lite-tapable"));
...
var MultiCompiler = class {
  constructor(compilers, options) {
    ...
    this.hooks = {
      done: new liteTapable10.SyncHook(["stats"]),
      invalid: new liteTapable10.MultiHook(
        normalizedCompilers.map((c) => c.hooks.invalid)
      ),
      run: new liteTapable10.MultiHook(normalizedCompilers.map((c) => c.hooks.run)),
      watchClose: new liteTapable10.SyncHook([]),
      watchRun: new liteTapable10.MultiHook(
        normalizedCompilers.map((c) => c.hooks.watchRun)
      ),
      infrastructureLog: new liteTapable10.MultiHook(
...
var SIMPLE_EXTRACTORS = {
  compilation: {
    ...
    version: (object) => {
      const { version: version2, webpackVersion } = require("../package.json");
...
Object.defineProperty(binding11.ContextModule.prototype, "emitFile", {
  enumerable: true,
  configurable: true,
  value(filename2, source, assetInfo) {
    return this._emitFile(filename2, JsSource.__to_binding(source), assetInfo);
...
Object.defineProperty(binding12.ConcatenatedModule.prototype, "emitFile", {
  enumerable: true,
  configurable: true,
  value(filename2, source, assetInfo) {
    return this._emitFile(filename2, JsSource.__to_binding(source), assetInfo);
...
Object.defineProperty(binding13.ExternalModule.prototype, "emitFile", {
  enumerable: true,
  configurable: true,
  value(filename2, source, assetInfo) {
    return this._emitFile(filename2, JsSource.__to_binding(source), assetInfo);
...
var dllReferencePluginOptionsContentItem = import_zod6.default.object({
  ...
  id: import_zod6.default.string().or(import_zod6.default.number()).optional()
});
...
var LoaderOptionsPlugin = class {
  ...
  apply(compiler) {
    ...
    compiler.hooks.compilation.tap("LoaderOptionsPlugin", (compilation) => {
      import_binding2.NormalModule.getCompilationHooks(compilation).loader.tap(
        "LoaderOptionsPlugin",
        (context2) => {
...
// src/config/utils.ts
var import_zod7 = require("../compiled/zod/index.js");
...
var _RspackZodUnion = class _RspackZodUnion extends import_zod7.z.ZodUnion {
  _parse(input) {
    ...
    function handleResults(results) {
      ...
      const unionErrors2 = results.map(
        (result2) => new import_zod7.ZodError(result2.ctx.common.issues)
      );
      (0, import_zod7.addIssueToContext)(ctx, {
        code: import_zod7.ZodIssueCode.invalid_union,
        unionErrors: unionErrors2
      });
      return import_zod7.INVALID;
    }
    if (ctx.common.async) {
      return Promise.all(
    ...
    const unionErrors = issues.map((issues2) => new import_zod7.ZodError(issues2));
    (0, import_zod7.addIssueToContext)(ctx, {
      code: import_zod7.ZodIssueCode.invalid_union,
      unionErrors
    });
...
_RspackZodUnion.create = (types, params) => {
  return new _RspackZodUnion({
    options: types,
    typeName: import_zod7.ZodFirstPartyTypeKind.ZodUnion,
    ...processCreateParams(params)
  });
};
var RspackZodUnion = _RspackZodUnion;
import_zod7.ZodUnion.create = RspackZodUnion.create;
var ZodRspackCrossChecker = class extends import_zod7.ZodType {
  constructor(params) {
    super(params);
    this.params = params;
  }
    ...
    for (const pattern of this.params.patterns) {
      if (pattern.test(root)) {
        ...
        for (const issue of issues) {
          (0, import_zod7.addIssueToContext)(ctx, issue);
        }
        return res;
      }
    }
...
// src/config/zod.ts
var filenameTemplate = import_zod8.z.string();
var filename = filenameTemplate.or(
  import_zod8.z.function().args(import_zod8.z.custom(), import_zod8.z.custom().optional()).returns(import_zod8.z.string())
);
...
var mode = import_zod8.z.enum([
  "development",
  "production",
  "none"
]);
var falsy = import_zod8.z.union([
  import_zod8.z.literal(false),
  import_zod8.z.literal(0),
  import_zod8.z.literal(""),
  import_zod8.z.null(),
  import_zod8.z.undefined()
]);
var publicPath = import_zod8.z.literal("auto").or(filename);
var baseUri = import_zod8.z.string();
var chunkLoadingType = import_zod8.z.enum(["jsonp", "import-scripts", "require", "async-node", "import"]).or(import_zod8.z.string());
var chunkLoading = import_zod8.z.literal(false).or(chunkLoadingType);
var asyncChunks = import_zod8.z.boolean();
var wasmLoadingType = import_zod8.z.enum(["fetch-streaming", "fetch", "async-node"]).or(import_zod8.z.string());
var wasmLoading = import_zod8.z.literal(false).or(wasmLoadingType);
var scriptType = import_zod8.z.enum(["text/javascript", "module"]).or(import_zod8.z.literal(false));
var libraryCustomUmdObject = import_zod8.z.strictObject({
  amd: import_zod8.z.string().optional(),
  commonjs: import_zod8.z.string().optional(),
  root: import_zod8.z.string().or(import_zod8.z.array(import_zod8.z.string())).optional()
});
var libraryName = import_zod8.z.string().or(import_zod8.z.array(import_zod8.z.string())).or(libraryCustomUmdObject);
var libraryCustomUmdCommentObject = import_zod8.z.strictObject({
  amd: import_zod8.z.string().optional(),
  commonjs: import_zod8.z.string().optional(),
  commonjs2: import_zod8.z.string().optional(),
  root: import_zod8.z.string().optional()
});
var amdContainer = import_zod8.z.string();
var auxiliaryComment = import_zod8.z.string().or(libraryCustomUmdCommentObject);
var libraryExport = import_zod8.z.string().or(import_zod8.z.array(import_zod8.z.string()));
var libraryType = import_zod8.z.enum([
  "var",
  "module",
  "assign",
  "assign-properties",
  ...
  "jsonp",
  "system"
]).or(import_zod8.z.string());
var umdNamedDefine = import_zod8.z.boolean();
var libraryOptions = import_zod8.z.strictObject({
...
var layer = import_zod8.z.string().or(import_zod8.z.null());
var entryFilename = filename;
var entryRuntime = import_zod8.z.literal(false).or(import_zod8.z.string());
var entryItem = import_zod8.z.string().or(import_zod8.z.array(import_zod8.z.string()));
var entryDependOn = import_zod8.z.string().or(import_zod8.z.array(import_zod8.z.string()));
var entryDescription = import_zod8.z.strictObject({
  import: entryItem,
...
var entryObject = import_zod8.z.record(
  entryItem.or(entryDescription)
);
var entryStatic = entryObject.or(
  entryUnnamed
);
var entryDynamic = import_zod8.z.function().returns(
...
var crossOriginLoading = import_zod8.z.literal(false).or(
  import_zod8.z.enum(["anonymous", "use-credentials"])
);
...
var hotUpdateGlobal = import_zod8.z.string();
var uniqueName = import_zod8.z.string();
var chunkLoadingGlobal = import_zod8.z.string();
var enabledLibraryTypes = import_zod8.z.array(
  libraryType
);
var clean = import_zod8.z.union([
  import_zod8.z.boolean(),
  import_zod8.z.strictObject({
    keep: import_zod8.z.string().optional()
  })
]);
var outputModule = import_zod8.z.boolean();
var strictModuleExceptionHandling = import_zod8.z.boolean();
var strictModuleErrorHandling = import_zod8.z.boolean();
var globalObject = import_zod8.z.string();
var enabledWasmLoadingTypes = import_zod8.z.array(
  wasmLoadingType
);
var importFunctionName = import_zod8.z.string();
var importMetaName = import_zod8.z.string();
var iife = import_zod8.z.boolean();
var enabledChunkLoadingTypes = import_zod8.z.array(
  chunkLoadingType
);
var chunkFormat = import_zod8.z.literal(false).or(import_zod8.z.string());
var workerPublicPath = import_zod8.z.string();
var trustedTypes = import_zod8.z.strictObject({
  policyName: import_zod8.z.string().optional(),
  onPolicyCreationFailure: import_zod8.z.enum(["continue", "stop"]).optional()
});
var hashDigest = import_zod8.z.string();
var hashDigestLength = import_zod8.z.number();
var hashFunction = import_zod8.z.enum([
  "md4",
  "xxhash64"
]);
var hashSalt = import_zod8.z.string();
var sourceMapFilename = import_zod8.z.string();
var devtoolNamespace = import_zod8.z.string();
var devtoolModuleFilenameTemplate = import_zod8.z.union([
  import_zod8.z.string(),
  import_zod8.z.function(import_zod8.z.tuple([import_zod8.z.any()]), import_zod8.z.any())
]);
var devtoolFallbackModuleFilenameTemplate = devtoolModuleFilenameTemplate;
var environment = import_zod8.z.strictObject({
  arrowFunction: import_zod8.z.boolean().optional(),
  asyncFunction: import_zod8.z.boolean().optional(),
  bigIntLiteral: import_zod8.z.boolean().optional(),
  const: import_zod8.z.boolean().optional(),
  destructuring: import_zod8.z.boolean().optional(),
  document: import_zod8.z.boolean().optional(),
  dynamicImport: import_zod8.z.boolean().optional(),
  dynamicImportInWorker: import_zod8.z.boolean().optional(),
  forOf: import_zod8.z.boolean().optional(),
  globalThis: import_zod8.z.boolean().optional(),
  module: import_zod8.z.boolean().optional(),
  nodePrefixForCoreModules: import_zod8.z.boolean().optional(),
  optionalChaining: import_zod8.z.boolean().optional(),
...
var output = import_zod8.z.strictObject({
  ...
  cssHeadDataCompression: import_zod8.z.boolean().optional(),
  ...
  trustedTypes: import_zod8.z.literal(true).or(import_zod8.z.string()).or(trustedTypes).optional(),
  ...
  chunkLoadTimeout: import_zod8.z.number().optional(),
  charset: import_zod8.z.boolean().optional(),
  environment: environment.optional(),
  compareBeforeEmit: import_zod8.z.boolean().optional()
});
...
var resolveTsConfig = resolveTsConfigFile.or(
  import_zod8.z.strictObject({
    ...
    references: import_zod8.z.array(import_zod8.z.string()).or(import_zod8.z.literal("auto")).optional()
  })
);
var baseResolveOptions = import_zod8.z.strictObject({
  alias: resolveAlias.optional(),
  conditionNames: import_zod8.z.array(import_zod8.z.string()).optional(),
  extensions: import_zod8.z.array(import_zod8.z.string()).optional(),
  fallback: resolveAlias.optional(),
  mainFields: import_zod8.z.array(import_zod8.z.string()).optional(),
  mainFiles: import_zod8.z.array(import_zod8.z.string()).optional(),
  modules: import_zod8.z.array(import_zod8.z.string()).optional(),
  preferRelative: import_zod8.z.boolean().optional(),
  preferAbsolute: import_zod8.z.boolean().optional(),
  symlinks: import_zod8.z.boolean().optional(),
  enforceExtension: import_zod8.z.boolean().optional(),
  importsFields: import_zod8.z.array(import_zod8.z.string()).optional(),
  descriptionFiles: import_zod8.z.array(import_zod8.z.string()).optional(),
  tsConfig: resolveTsConfig.optional(),
  fullySpecified: import_zod8.z.boolean().optional(),
  exportsFields: import_zod8.z.array(import_zod8.z.string()).optional(),
  extensionAlias: import_zod8.z.record(import_zod8.z.string().or(import_zod8.z.array(import_zod8.z.string()))).optional(),
  aliasFields: import_zod8.z.array(import_zod8.z.string()).optional(),
  restrictions: import_zod8.z.array(import_zod8.z.string()).optional(),
  roots: import_zod8.z.array(import_zod8.z.string()).optional(),
  pnp: import_zod8.z.boolean().optional()
});
var resolveOptions = baseResolveOptions.extend({
  byDependency: import_zod8.z.lazy(() => import_zod8.z.record(resolveOptions)).optional()
});
var baseRuleSetCondition = import_zod8.z.instanceof(RegExp).or(import_zod8.z.string()).or(import_zod8.z.function().args(import_zod8.z.string()).returns(import_zod8.z.boolean()));
var ruleSetCondition = baseRuleSetCondition.or(import_zod8.z.lazy(() => ruleSetConditions)).or(import_zod8.z.lazy(() => ruleSetLogicalConditions));
var ruleSetConditions = import_zod8.z.lazy(
  () => import_zod8.z.array(ruleSetCondition)
);
var ruleSetLogicalConditions = import_zod8.z.strictObject({
  and: ruleSetConditions.optional(),
  or: ruleSetConditions.optional(),
  not: ruleSetCondition.optional()
});
var ruleSetLoader = import_zod8.z.string();
var ruleSetLoaderOptions = import_zod8.z.string().or(import_zod8.z.record(import_zod8.z.any()));
...
var ruleSetUse = ruleSetUseItem.or(ruleSetUseItem.array()).or(
  import_zod8.z.function().args(import_zod8.z.custom()).returns(ruleSetUseItem.array())
);
var baseRuleSetRule = import_zod8.z.strictObject({
  ...
  descriptionData: import_zod8.z.record(ruleSetCondition).optional(),
  with: import_zod8.z.record(ruleSetCondition).optional(),
  type: import_zod8.z.string().optional(),
  layer: import_zod8.z.string().optional(),
  loader: ruleSetLoader.optional(),
  options: ruleSetLoaderOptions.optional(),
  use: ruleSetUse.optional(),
  parser: import_zod8.z.record(import_zod8.z.any()).optional(),
  generator: import_zod8.z.record(import_zod8.z.any()).optional(),
  resolve: resolveOptions.optional(),
  sideEffects: import_zod8.z.boolean().optional(),
  enforce: import_zod8.z.literal("pre").or(import_zod8.z.literal("post")).optional()
});
var ruleSetRule = baseRuleSetRule.extend({
  oneOf: import_zod8.z.lazy(() => ruleSetRule.or(falsy).array()).optional(),
  rules: import_zod8.z.lazy(() => ruleSetRule.or(falsy).array()).optional()
});
var ruleSetRules = import_zod8.z.array(
  import_zod8.z.literal("...").or(ruleSetRule).or(falsy)
);
var assetParserDataUrlOptions = import_zod8.z.strictObject({
  maxSize: import_zod8.z.number().optional()
});
var assetParserDataUrl = assetParserDataUrlOptions;
var assetParserOptions = import_zod8.z.strictObject({
  dataUrlCondition: assetParserDataUrl.optional()
});
var cssParserNamedExports = import_zod8.z.boolean();
var cssParserOptions = import_zod8.z.strictObject({
  namedExports: cssParserNamedExports.optional()
});
var cssAutoParserOptions = import_zod8.z.strictObject({
  namedExports: cssParserNamedExports.optional()
});
var cssModuleParserOptions = import_zod8.z.strictObject({
  namedExports: cssParserNamedExports.optional()
});
var dynamicImportMode = import_zod8.z.enum(["eager", "lazy", "weak", "lazy-once"]);
var dynamicImportPreload = import_zod8.z.union([import_zod8.z.boolean(), import_zod8.z.number()]);
var dynamicImportPrefetch = import_zod8.z.union([import_zod8.z.boolean(), import_zod8.z.number()]);
var dynamicImportFetchPriority = import_zod8.z.enum(["low", "high", "auto"]);
var javascriptParserUrl = import_zod8.z.union([import_zod8.z.literal("relative"), import_zod8.z.boolean()]);
var exprContextCritical = import_zod8.z.boolean();
var wrappedContextCritical = import_zod8.z.boolean();
var wrappedContextRegExp = import_zod8.z.instanceof(RegExp);
var exportsPresence = import_zod8.z.enum(["error", "warn", "auto"]).or(import_zod8.z.literal(false));
var importExportsPresence = import_zod8.z.enum(["error", "warn", "auto"]).or(import_zod8.z.literal(false));
var reexportExportsPresence = import_zod8.z.enum(["error", "warn", "auto"]).or(import_zod8.z.literal(false));
var strictExportPresence = import_zod8.z.boolean();
var worker = import_zod8.z.array(import_zod8.z.string()).or(import_zod8.z.boolean());
var overrideStrict = import_zod8.z.enum(["strict", "non-strict"]);
var requireAsExpression = import_zod8.z.boolean();
var requireDynamic = import_zod8.z.boolean();
var requireResolve = import_zod8.z.boolean();
var importDynamic = import_zod8.z.boolean();
var javascriptParserOptions = import_zod8.z.strictObject({
  ...
  importMeta: import_zod8.z.boolean().optional(),
...
var parserOptionsByModuleTypeKnown = import_zod8.z.strictObject({
...
var parserOptionsByModuleTypeUnknown = import_zod8.z.record(
  import_zod8.z.record(import_zod8.z.any())
);
var parserOptionsByModuleType = parserOptionsByModuleTypeKnown.or(
  parserOptionsByModuleTypeUnknown
);
var assetGeneratorDataUrlOptions = import_zod8.z.strictObject({
  encoding: import_zod8.z.literal(false).or(import_zod8.z.literal("base64")).optional(),
  mimetype: import_zod8.z.string().optional()
});
var assetGeneratorDataUrlFunction = import_zod8.z.function().args(
  import_zod8.z.instanceof(Buffer),
  import_zod8.z.strictObject({
    filename: import_zod8.z.string(),
    module: import_zod8.z.custom()
  })
).returns(import_zod8.z.string());
var assetGeneratorDataUrl = assetGeneratorDataUrlOptions.or(
  assetGeneratorDataUrlFunction
);
var assetInlineGeneratorOptions = import_zod8.z.strictObject({
  dataUrl: assetGeneratorDataUrl.optional()
});
var assetResourceGeneratorOptions = import_zod8.z.strictObject({
  emit: import_zod8.z.boolean().optional(),
  filename: filename.optional(),
  publicPath: publicPath.optional()
});
...
var cssGeneratorExportsConvention = import_zod8.z.enum([
  "as-is",
  "camel-case",
  "camel-case-only",
  "dashes",
...
var cssGeneratorExportsOnly = import_zod8.z.boolean();
var cssGeneratorLocalIdentName = import_zod8.z.string();
var cssGeneratorEsModule = import_zod8.z.boolean();
var cssGeneratorOptions = import_zod8.z.strictObject({
  exportsOnly: cssGeneratorExportsOnly.optional(),
  esModule: cssGeneratorEsModule.optional()
});
var cssAutoGeneratorOptions = import_zod8.z.strictObject({
  exportsConvention: cssGeneratorExportsConvention.optional(),
  exportsOnly: cssGeneratorExportsOnly.optional(),
  localIdentName: cssGeneratorLocalIdentName.optional(),
  esModule: cssGeneratorEsModule.optional()
});
var cssModuleGeneratorOptions = import_zod8.z.strictObject({
  exportsConvention: cssGeneratorExportsConvention.optional(),
  exportsOnly: cssGeneratorExportsOnly.optional(),
  localIdentName: cssGeneratorLocalIdentName.optional(),
  esModule: cssGeneratorEsModule.optional()
});
var jsonGeneratorOptions = import_zod8.z.strictObject({
  JSONParse: import_zod8.z.boolean().optional()
});
var generatorOptionsByModuleTypeKnown = import_zod8.z.strictObject({
...
var generatorOptionsByModuleTypeUnknown = import_zod8.z.record(
  import_zod8.z.record(import_zod8.z.any())
);
var generatorOptionsByModuleType = generatorOptionsByModuleTypeKnown.or(
  generatorOptionsByModuleTypeUnknown
);
var noParseOptionSingle = import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.function().args(import_zod8.z.string()).returns(import_zod8.z.boolean()));
var noParseOption = noParseOptionSingle.or(
  import_zod8.z.array(noParseOptionSingle)
);
var moduleOptions = import_zod8.z.strictObject({
...
var allowTarget = import_zod8.z.union([
  import_zod8.z.enum([
    "web",
    "webworker",
    "es3",
  ...
  import_zod8.z.literal("node"),
  import_zod8.z.literal("async-node"),
  import_zod8.z.custom(
  ...
  import_zod8.z.literal("electron-main"),
  import_zod8.z.custom(
  ...
  import_zod8.z.literal("electron-renderer"),
  import_zod8.z.custom(
  ...
  import_zod8.z.literal("electron-preload"),
  import_zod8.z.custom(
  ...
  import_zod8.z.literal("node-webkit"),
  import_zod8.z.custom(
  ...
  import_zod8.z.literal("browserslist"),
  import_zod8.z.custom(
    (value) => typeof value === "string" && /^browserslist:(.+)$/.test(value)
  )
]);
var target = import_zod8.z.union([
  import_zod8.z.literal(false),
  allowTarget,
  allowTarget.array()
]);
var externalsType = import_zod8.z.enum([
  "var",
  "module",
  "assign",
  "this",
...
var externalObjectValue = new ZodRspackCrossChecker({
  patterns: [
    {
      test: (config2) => {
        var _a, _b;
      ...
      type: import_zod8.z.strictObject({
        root: import_zod8.z.string().or(import_zod8.z.string().array()),
        commonjs: import_zod8.z.string().or(import_zod8.z.string().array()),
        commonjs2: import_zod8.z.string().or(import_zod8.z.string().array()),
        amd: import_zod8.z.string().or(import_zod8.z.string().array())
      }),
      issue: (res) => {
        if (res.status === "aborted") {
          return [
            {
              fatal: true,
              code: import_zod8.ZodIssueCode.custom,
  ...
  default: import_zod8.z.record(import_zod8.z.string().or(import_zod8.z.string().array()))
});
var externalItemValue = import_zod8.z.string().or(import_zod8.z.boolean()).or(import_zod8.z.string().array().min(1)).or(externalObjectValue);
var externalItemObjectUnknown = import_zod8.z.record(
  externalItemValue
);
var externalItemFunctionData = import_zod8.z.strictObject({
  context: import_zod8.z.string().optional(),
  dependencyType: import_zod8.z.string().optional(),
  request: import_zod8.z.string().optional(),
  contextInfo: import_zod8.z.strictObject({
    issuer: import_zod8.z.string(),
    issuerLayer: import_zod8.z.string().or(import_zod8.z.null()).optional()
  }).optional(),
  getResolve: import_zod8.z.function().returns(
    import_zod8.z.function().args(import_zod8.z.string(), import_zod8.z.string()).returns(import_zod8.z.promise(import_zod8.z.string())).or(
      import_zod8.z.function().args(import_zod8.z.string(), import_zod8.z.string(), import_zod8.z.custom()).returns(import_zod8.z.void())
    )
  ).optional()
});
var externalItem = import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).or(externalItemObjectUnknown).or(
  import_zod8.z.function().args(
    externalItemFunctionData,
    import_zod8.z.function().args(
      import_zod8.z.instanceof(Error).optional(),
      externalItemValue.optional(),
      externalsType.optional()
    ).returns(import_zod8.z.void())
  )
).or(
  import_zod8.z.function().args(externalItemFunctionData).returns(import_zod8.z.promise(externalItemValue))
).or(
  import_zod8.z.function().args(externalItemFunctionData).returns(externalItemValue)
);
var externals = externalItem.array().or(externalItem);
var externalsPresets = import_zod8.z.strictObject({
  node: import_zod8.z.boolean().optional(),
  web: import_zod8.z.boolean().optional(),
  webAsync: import_zod8.z.boolean().optional(),
  electron: import_zod8.z.boolean().optional(),
  electronMain: import_zod8.z.boolean().optional(),
  electronPreload: import_zod8.z.boolean().optional(),
  electronRenderer: import_zod8.z.boolean().optional(),
  nwjs: import_zod8.z.boolean().optional()
});
var filterItemTypes = import_zod8.z.instanceof(RegExp).or(import_zod8.z.string()).or(
  import_zod8.z.function().args(import_zod8.z.string()).returns(import_zod8.z.boolean())
);
var filterTypes = filterItemTypes.array().or(filterItemTypes);
var infrastructureLogging = import_zod8.z.strictObject({
  appendOnly: import_zod8.z.boolean().optional(),
  colors: import_zod8.z.boolean().optional(),
  console: import_zod8.z.custom().optional(),
  debug: import_zod8.z.boolean().or(filterTypes).optional(),
  level: import_zod8.z.enum(["none", "error", "warn", "info", "log", "verbose"]).optional(),
  stream: import_zod8.z.custom().optional()
});
var devTool = import_zod8.z.literal(false).or(
  import_zod8.z.enum([
    "eval",
    "cheap-source-map",
...
var nodeOptions = import_zod8.z.strictObject({
  __dirname: import_zod8.z.boolean().or(import_zod8.z.enum(["warn-mock", "mock", "eval-only", "node-module"])).optional(),
  __filename: import_zod8.z.boolean().or(import_zod8.z.enum(["warn-mock", "mock", "eval-only", "node-module"])).optional(),
  global: import_zod8.z.boolean().or(import_zod8.z.literal("warn")).optional()
});
var node = import_zod8.z.literal(false).or(nodeOptions);
var loader = import_zod8.z.record(import_zod8.z.string(), import_zod8.z.any());
var snapshotOptions = import_zod8.z.strictObject(
  {}
);
var cacheOptions = import_zod8.z.boolean();
var statsPresets = import_zod8.z.enum([
  "normal",
  "none",
  "verbose",
  "errors-only",
...
var statsOptions = import_zod8.z.strictObject({
  all: import_zod8.z.boolean().optional(),
  preset: import_zod8.z.boolean().or(statsPresets).optional(),
  assets: import_zod8.z.boolean().optional(),
  chunks: import_zod8.z.boolean().optional(),
  modules: import_zod8.z.boolean().optional(),
  entrypoints: import_zod8.z.boolean().or(import_zod8.z.literal("auto")).optional(),
  chunkGroups: import_zod8.z.boolean().optional(),
  warnings: import_zod8.z.boolean().optional(),
  warningsCount: import_zod8.z.boolean().optional(),
  errors: import_zod8.z.boolean().optional(),
  errorsCount: import_zod8.z.boolean().optional(),
  colors: import_zod8.z.boolean().optional(),
  hash: import_zod8.z.boolean().optional(),
  version: import_zod8.z.boolean().optional(),
  reasons: import_zod8.z.boolean().optional(),
  publicPath: import_zod8.z.boolean().optional(),
  outputPath: import_zod8.z.boolean().optional(),
  chunkModules: import_zod8.z.boolean().optional(),
  chunkRelations: import_zod8.z.boolean().optional(),
  ids: import_zod8.z.boolean().optional(),
  timings: import_zod8.z.boolean().optional(),
  builtAt: import_zod8.z.boolean().optional(),
  moduleAssets: import_zod8.z.boolean().optional(),
  nestedModules: import_zod8.z.boolean().optional(),
  source: import_zod8.z.boolean().optional(),
  logging: import_zod8.z.enum(["none", "error", "warn", "info", "log", "verbose"]).or(import_zod8.z.boolean()).optional(),
  loggingDebug: import_zod8.z.boolean().or(filterTypes).optional(),
  loggingTrace: import_zod8.z.boolean().optional(),
  runtimeModules: import_zod8.z.boolean().optional(),
  children: import_zod8.z.boolean().optional(),
  usedExports: import_zod8.z.boolean().optional(),
  providedExports: import_zod8.z.boolean().optional(),
  optimizationBailout: import_zod8.z.boolean().optional(),
  groupModulesByType: import_zod8.z.boolean().optional(),
  groupModulesByCacheStatus: import_zod8.z.boolean().optional(),
  groupModulesByLayer: import_zod8.z.boolean().optional(),
  groupModulesByAttributes: import_zod8.z.boolean().optional(),
  groupModulesByPath: import_zod8.z.boolean().optional(),
  groupModulesByExtension: import_zod8.z.boolean().optional(),
  modulesSpace: import_zod8.z.number().optional(),
  chunkModulesSpace: import_zod8.z.number().optional(),
  nestedModulesSpace: import_zod8.z.number().optional(),
  relatedAssets: import_zod8.z.boolean().optional(),
  groupAssetsByEmitStatus: import_zod8.z.boolean().optional(),
  groupAssetsByInfo: import_zod8.z.boolean().optional(),
  groupAssetsByPath: import_zod8.z.boolean().optional(),
  groupAssetsByExtension: import_zod8.z.boolean().optional(),
  groupAssetsByChunk: import_zod8.z.boolean().optional(),
  assetsSpace: import_zod8.z.number().optional(),
  orphanModules: import_zod8.z.boolean().optional(),
  excludeModules: import_zod8.z.array(
    import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.function(import_zod8.z.tuple([import_zod8.z.string(), import_zod8.z.any(), import_zod8.z.any()]), import_zod8.z.boolean()))
  ).or(import_zod8.z.string()).or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.function(import_zod8.z.tuple([import_zod8.z.string(), import_zod8.z.any(), import_zod8.z.any()]), import_zod8.z.boolean())).or(import_zod8.z.boolean()).optional(),
  excludeAssets: import_zod8.z.array(
    import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.function(import_zod8.z.tuple([import_zod8.z.string(), import_zod8.z.any()]), import_zod8.z.boolean()))
  ).or(import_zod8.z.string()).or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.function(import_zod8.z.tuple([import_zod8.z.string(), import_zod8.z.any()]), import_zod8.z.boolean())).optional(),
  modulesSort: import_zod8.z.string().optional(),
  chunkModulesSort: import_zod8.z.string().optional(),
  nestedModulesSort: import_zod8.z.string().optional(),
  chunksSort: import_zod8.z.string().optional(),
  assetsSort: import_zod8.z.string().optional(),
  performance: import_zod8.z.boolean().optional(),
  env: import_zod8.z.boolean().optional(),
  chunkGroupAuxiliary: import_zod8.z.boolean().optional(),
  chunkGroupChildren: import_zod8.z.boolean().optional(),
  chunkGroupMaxAssets: import_zod8.z.number().optional(),
  dependentModules: import_zod8.z.boolean().optional(),
  chunkOrigins: import_zod8.z.boolean().optional(),
  runtime: import_zod8.z.boolean().optional(),
  depth: import_zod8.z.boolean().optional(),
  reasonsSpace: import_zod8.z.number().optional(),
  groupReasonsByOrigin: import_zod8.z.boolean().optional(),
  errorDetails: import_zod8.z.boolean().optional(),
  errorStack: import_zod8.z.boolean().optional(),
  moduleTrace: import_zod8.z.boolean().optional(),
  cachedModules: import_zod8.z.boolean().optional(),
  cachedAssets: import_zod8.z.boolean().optional(),
  cached: import_zod8.z.boolean().optional(),
  errorsSpace: import_zod8.z.number().optional(),
  warningsSpace: import_zod8.z.number().optional()
});
var statsValue = import_zod8.z.boolean().or(statsPresets).or(statsOptions);
var plugin = import_zod8.z.union([
  import_zod8.z.custom(),
  falsy
]);
var plugins = plugin.array();
var optimizationRuntimeChunk = import_zod8.z.enum(["single", "multiple"]).or(import_zod8.z.boolean()).or(
  import_zod8.z.strictObject({
    name: import_zod8.z.string().or(
      import_zod8.z.function().args(import_zod8.z.strictObject({ name: import_zod8.z.string() })).returns(import_zod8.z.string())
    ).optional()
  })
);
...
var optimizationSplitChunksChunks = import_zod8.z.enum(["initial", "async", "all"]).or(import_zod8.z.instanceof(RegExp)).or(
  import_zod8.z.function().args(import_zod8.z.instanceof(Chunk, { message: "Input not instance of Chunk" })).returns(import_zod8.z.boolean())
);
var optimizationSplitChunksSizes = import_zod8.z.number().or(import_zod8.z.record(import_zod8.z.number()));
var optimizationSplitChunksDefaultSizeTypes = import_zod8.z.array(import_zod8.z.string());
var sharedOptimizationSplitChunksCacheGroup = {
  chunks: optimizationSplitChunksChunks.optional(),
  defaultSizeTypes: optimizationSplitChunksDefaultSizeTypes.optional(),
  minChunks: import_zod8.z.number().min(1).optional(),
  usedExports: import_zod8.z.boolean().optional(),
  ...
  maxAsyncRequests: import_zod8.z.number().optional(),
  maxInitialRequests: import_zod8.z.number().optional(),
  automaticNameDelimiter: import_zod8.z.string().optional()
};
var optimizationSplitChunksCacheGroup = import_zod8.z.strictObject({
  test: import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).or(
    ...
    ).returns(import_zod8.z.boolean())
  ).optional(),
  priority: import_zod8.z.number().optional(),
  enforce: import_zod8.z.boolean().optional(),
  reuseExistingChunk: import_zod8.z.boolean().optional(),
  type: import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).optional(),
  idHint: import_zod8.z.string().optional(),
  layer: import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.function(import_zod8.z.tuple([import_zod8.z.string().optional()]), import_zod8.z.boolean())).optional(),
  ...sharedOptimizationSplitChunksCacheGroup
});
var optimizationSplitChunksOptions = import_zod8.z.strictObject({
  cacheGroups: import_zod8.z.record(import_zod8.z.literal(false).or(optimizationSplitChunksCacheGroup)).optional(),
  fallbackCacheGroup: import_zod8.z.strictObject({
    chunks: optimizationSplitChunksChunks.optional(),
    minSize: import_zod8.z.number().optional(),
    maxSize: import_zod8.z.number().optional(),
    maxAsyncSize: import_zod8.z.number().optional(),
    maxInitialSize: import_zod8.z.number().optional(),
    automaticNameDelimiter: import_zod8.z.string().optional()
  }).optional(),
  hidePathInfo: import_zod8.z.boolean().optional(),
  ...sharedOptimizationSplitChunksCacheGroup
});
var optimization = import_zod8.z.strictObject({
  moduleIds: import_zod8.z.enum(["named", "natural", "deterministic"]).optional(),
  chunkIds: import_zod8.z.enum(["natural", "named", "deterministic", "size", "total-size"]).optional(),
  minimize: import_zod8.z.boolean().optional(),
  minimizer: import_zod8.z.literal("...").or(plugin).array().optional(),
  mergeDuplicateChunks: import_zod8.z.boolean().optional(),
  splitChunks: import_zod8.z.literal(false).or(optimizationSplitChunksOptions).optional(),
  runtimeChunk: optimizationRuntimeChunk.optional(),
  removeAvailableModules: import_zod8.z.boolean().optional(),
  removeEmptyChunks: import_zod8.z.boolean().optional(),
  realContentHash: import_zod8.z.boolean().optional(),
  sideEffects: import_zod8.z.enum(["flag"]).or(import_zod8.z.boolean()).optional(),
  providedExports: import_zod8.z.boolean().optional(),
  concatenateModules: import_zod8.z.boolean().optional(),
  innerGraph: import_zod8.z.boolean().optional(),
  usedExports: import_zod8.z.enum(["global"]).or(import_zod8.z.boolean()).optional(),
  mangleExports: import_zod8.z.enum(["size", "deterministic"]).or(import_zod8.z.boolean()).optional(),
  nodeEnv: import_zod8.z.union([import_zod8.z.string(), import_zod8.z.literal(false)]).optional(),
  emitOnErrors: import_zod8.z.boolean().optional(),
  avoidEntryIife: import_zod8.z.boolean().optional()
});
var rspackFutureOptions = import_zod8.z.strictObject({
  bundlerInfo: import_zod8.z.strictObject({
    version: import_zod8.z.string().optional(),
    bundler: import_zod8.z.string().optional(),
...
var experimentCacheOptions = import_zod8.z.object({
  ...
  import_zod8.z.object({
    type: import_zod8.z.enum(["persistent"]),
    buildDependencies: import_zod8.z.string().array().optional(),
    version: import_zod8.z.string().optional(),
    snapshot: import_zod8.z.object({
      immutablePaths: import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).array().optional(),
      unmanagedPaths: import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).array().optional(),
      managedPaths: import_zod8.z.string().or(import_zod8.z.instanceof(RegExp)).array().optional()
    }).optional(),
    storage: import_zod8.z.object({
      type: import_zod8.z.enum(["filesystem"]),
      directory: import_zod8.z.string().optional()
    }).optional()
  })
);
...
var incremental = import_zod8.z.strictObject({
  ...
  inferAsyncModules: import_zod8.z.boolean().optional(),
  providedExports: import_zod8.z.boolean().optional(),
  dependenciesDiagnostics: import_zod8.z.boolean().optional(),
  sideEffects: import_zod8.z.boolean().optional(),
  buildChunkGraph: import_zod8.z.boolean().optional(),
  moduleIds: import_zod8.z.boolean().optional(),
  chunkIds: import_zod8.z.boolean().optional(),
  modulesHashes: import_zod8.z.boolean().optional(),
  modulesCodegen: import_zod8.z.boolean().optional(),
  modulesRuntimeRequirements: import_zod8.z.boolean().optional(),
  chunksRuntimeRequirements: import_zod8.z.boolean().optional(),
  chunksHashes: import_zod8.z.boolean().optional(),
...
var experiments = import_zod8.z.strictObject({
  ...
  asyncWebAssembly: import_zod8.z.boolean().optional(),
  outputModule: import_zod8.z.boolean().optional(),
  topLevelAwait: import_zod8.z.boolean().optional(),
  css: import_zod8.z.boolean().optional(),
  layers: import_zod8.z.boolean().optional(),
...
var watchOptions = import_zod8.z.strictObject({
  aggregateTimeout: import_zod8.z.number().optional(),
  followSymlinks: import_zod8.z.boolean().optional(),
  ignored: import_zod8.z.string().array().or(import_zod8.z.instanceof(RegExp)).or(import_zod8.z.string()).optional(),
  poll: import_zod8.z.number().or(import_zod8.z.boolean()).optional(),
  stdin: import_zod8.z.boolean().optional()
});
var devServer = import_zod8.z.custom();
var ignoreWarnings = import_zod8.z.instanceof(RegExp).or(
  import_zod8.z.function().args(import_zod8.z.instanceof(Error), import_zod8.z.custom()).returns(import_zod8.z.boolean())
).array();
var profile = import_zod8.z.boolean();
var amd = import_zod8.z.literal(false).or(import_zod8.z.record(import_zod8.z.any()));
var bail = import_zod8.z.boolean();
var performance = import_zod8.z.strictObject({
  assetFilter: import_zod8.z.function().args(import_zod8.z.string()).returns(import_zod8.z.boolean()).optional(),
  hints: import_zod8.z.enum(["error", "warning"]).or(import_zod8.z.literal(false)).optional(),
  maxAssetSize: import_zod8.z.number().optional(),
  maxEntrypointSize: import_zod8.z.number().optional()
}).or(import_zod8.z.literal(false));
var rspackOptions = import_zod8.z.strictObject({
  name: name.optional(),
  dependencies: dependencies.optional(),
  extends: import_zod8.z.union([import_zod8.z.string(), import_zod8.z.array(import_zod8.z.string())]).optional(),
